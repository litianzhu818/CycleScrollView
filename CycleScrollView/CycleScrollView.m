...
- (MyPageControl *)pageControl
{
    ...
    if (self.totalPageCount > 1) {
        if (!_pageControl) {
            ...
            NSString *normalImageName = [@"CycleScrollView.bundle" stringByAppendingPathComponent:@"page_state_normal.png"];
            NSString *highlightImageName = [@"CycleScrollView.bundle" stringByAppendingPathComponent:@"page_state_highlight.png"];
            ...
            CGRect pageControlFrame = CGRectMake((CGRectGetWidth(self.scrollView.frame) - pageControlWidth - 10) , (CGRectGetHeight(self.scrollView.frame)-normalDotImage.size.height - 10), pageControlWidth, normalDotImage.size.height);
